...
p = protocol_281b9('153.60.64.126', 1099, '126', 1, False)
...
p.sendMEMBER_ID('7708227141', '7708227141')

# trigger normal tiered discount
ScanItem('battery pack', 1)
ScanItem('battery pack', 2)
ScanItem('battery pack', 3)
ScanItem('battery pack', 4)

# trigger tiered cashback
ScanItem('battery pack A', 5)
ScanItem('battery pack A', 6)
ScanItem('battery pack A', 7)
ScanItem('battery pack A', 8)

p.sendTOTAL(total, subtotal)

#void a few items
VoidItem('battery pack', 3)
VoidItem('battery pack', 4)
