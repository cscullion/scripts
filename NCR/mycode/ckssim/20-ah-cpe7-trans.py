...
def ScanItem(desc, entryID):
    ...
    total, subtotal = p.sendITEM_ENTRY(lItem.upc, entryID, lItem.dept, 0, lItem.price, 1, 1, lItem.desc, total, subtotal)
...
plu.addItem(Item('00008065750406', 'offer 20 item', 4.19, 4))
...
ScanItem('offer 20 item', 1)
ScanItem('offer 20 item', 2)
ScanItem('offer 20 item', 3)
ScanItem('offer 20 item', 4)
