...
plu.addItem(Item('00000000000301', 'item 301', 1.00, 1))
plu.addItem(Item('00000000000302', 'item 302', 1.00, 1))
plu.addItem(Item('00000000000303', 'item 303', 1.00, 1))
...
ScanItemQty('item 300', 1, 1)
ScanItemTrigger('00002400000300', 2)

p.sendALT_ID('7706237176', '7706237176', '03')

p.sendTOTAL(total, subtotal)

total -= p.getDiscounts()

#if p.getMemberIDfromAltID() != '':
#    p.sendMEMBER_ID(p.getMemberIDfromAltID(), p.getMemberIDfromAltID())
